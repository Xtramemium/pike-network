...
export const mockSiteData = {
  network: {
    ...
    journey: [
      "Пользователь попадает на главную и понимает, что это сеть Бар Щука.",
      "Выбирает точку по адресу и визуально сравнивает настроение каждой локации.",
      "Переходит на страницу бара и уже там смотрит меню, события, карту и контакты.",
    ],
    cta: {
    ...
    faq: [
      {
        question: "Это один бар или уже сеть?",
        answer:
          "Сейчас сайт уже собран как сеть Бар Щука: есть главная страница бренда и отдельные страницы каждой точки.",
      },
      {
        question: "У точек будет разный контент?",
        answer:
          "Да. Для каждой локации предусмотрены свои hero, события, меню, адрес, контакты и локальное SEO.",
      },
      {
        question: "Как сейчас связаться с баром?",
        answer:
          "На текущем этапе основной сценарий связи — звонок по общему номеру телефона, который выведен и на главной, и на страницах точек.",
      },
    ],
  ...
  bars: [
    {
      ...
      bestFor: [
        "Смотреть матч большой компанией",
        "Собраться на плотный ужин и барный вечер",
        "Выбрать более камерную точку сети",
      ],
      hero: {
    ...
    },
    {
      ...
      bestFor: [
        "Встретиться ближе к своей локации",
        "Следить за отдельными анонсами точки",
        "Получить свой локальный сценарий вечера",
      ],
      hero: {
        eyebrow: "Бар Щука · Люберцы",
